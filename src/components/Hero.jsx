import { CloudArrowUpIcon, ServerIcon, PaperAirplaneIcon, DeviceTabletIcon } from '@heroicons/react/24/outline';
      ...
      <div className='grid md:grid-cols-2 max-w-[1240px] m-auto'>
        ...
        >
          ...
          <div className='flex justify-between flex-wrap px-4'>
            ...
            <p className='flex px-4 py-2 text-slate-500'>
              <DeviceTabletIcon className='h-6 text-indigo-600' /> Dashboard Design
            </p>
            <p className='flex px-4 py-2 text-slate-500'>
